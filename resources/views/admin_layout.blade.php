			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URl::to('all-slider')}}"><i class="icon-edit"></i><span class="hidden-tablet">All Sliders</span></a></li>
						<li><a href="{{URl::to('add-slider')}}"><i class="icon-edit"></i><span class="hidden-tablet">Add Sliders</span></a></li>


						<li><a href="{{URl::to('all-socialmedia')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">All Social Icons</span></a></li>
						<li><a href="{{URl::to('add-socialmedia')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Social Icons</span></a></li>


						<li><a href="#"><i class="icon-font"></i><span class="hidden-tablet"> Shop Name</span></a></li>


						<li><a href="{{URl::to('all-message')}}"><i class="icon-picture"></i><span class="hidden-tablet">Messages</span></a></li>
